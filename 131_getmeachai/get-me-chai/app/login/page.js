        ...
        <div className="min-h-screen flex items-center justify-center ">
            <div className="bg-gray-900 rounded-xl shadow-lg p-10 w-full max-w-md">
                ...
                <div className="flex flex-col gap-4">
                    <button className="flex items-center justify-center gap-3 w-full py-3 px-6 rounded-lg bg-white hover:bg-gray-100 transition font-semibold text-gray-800 shadow border border-gray-200">
