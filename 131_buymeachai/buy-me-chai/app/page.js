  ...
  return (
    <>
      ...
      <div className=" text-white container mx-auto">
        ...
        <div className="flex gap-5 justify-around mx-20 my-10 ">
          <div className="item space-y-3 flex flex-col items-center justify-center">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/ARTjOh0hPfg?si=VzPgZWocLQ1k1QBe" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>            <p className="text-white">Fund Yourself</p>
            <p className="text-white">Fans are available to help you</p>
          </div>
